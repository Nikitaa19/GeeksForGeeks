<h2><a href="https://www.geeksforgeeks.org/problems/check-if-divisible-by-52730/1?page=6&category=Mathematical&difficulty=Basic&sortBy=submissions">Check if divisible by 5</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N in the form of string, the task is to check if the number is divisible by 5.&nbsp;</span></p>
